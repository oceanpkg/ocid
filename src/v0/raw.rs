...
impl RawOcidV0 {
    ...
    #[inline]
    pub fn from_bytes(bytes: [u8; SIZE]) -> RawOcidV0 {
    ...
    pub fn encode_base64_uninit<'b>(
        ...
        base64::encode_42(self.as_bytes(), buf)
    }
}
